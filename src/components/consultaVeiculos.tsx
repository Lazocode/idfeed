      ...
      {veiculo && (
        <div id="prontuario-veiculo" className="space-y-6 text-left animate-in fade-in duration-200">
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 sm:p-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 sm:gap-6 pb-6 border-b border-slate-100">
          ...
          <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-4 sm:p-8">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 pb-4 mb-4 border-b border-slate-100">
              ...
              <span className="self-start sm:self-auto px-2.5 py-1 text-xs font-medium rounded bg-slate-100 text-slate-700 border border-slate-200">
